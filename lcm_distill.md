...
Most of the parameters are identical to the parameters in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#script-parameters) training guide, so you'll focus on the parameters that are relevant to latent consistency distillation in this guide.
...
If you want to learn more about how the training loop works, check out the [Understanding pipelines, models and schedulers tutorial](fort-obsidian/diffusers/docs/source/en/using-diffusers/write_own_pipeline.md) which breaks down the basic pattern of the denoising process.
...
The LoRA training script is discussed in more detail in the [LoRA training](fort-obsidian/diffusers/docs/source/en/training/lora.md) guide.
