...
Most of the parameters are identical to the parameters in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#script-parameters) training guide, so you'll focus on the parameters that are relevant to training SDXL in this guide.
...
The training script is also similar to the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#training-script) training guide, but it's been modified to support SDXL training. This guide will focus on the code that is unique to the SDXL training script.
...
- Read the [Stable Diffusion XL](fort-obsidian/diffusers/docs/source/en/using-diffusers/sdxl.md) guide to learn how to use it for a variety of different tasks (text-to-image, image-to-image, inpainting), how to use it's refiner model, and the different types of micro-conditionings.
- Check out the [DreamBooth](fort-obsidian/diffusers/docs/source/en/training/dreambooth.md) and [LoRA](fort-obsidian/diffusers/docs/source/en/training/lora.md) training guides to learn how to train a personalized SDXL model with just a few example images. These two training techniques can even be combined!