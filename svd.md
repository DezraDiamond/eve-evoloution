...
To learn how to use Stable Video Diffusion, take a look at the [Stable Video Diffusion](fort-obsidian/diffusers/docs/source/en/using-diffusers/svd.md) guide.
...
Check out the [Text or image-to-video](text-img2vid.md) guide for more details about how certain parameters can affect video generation and how to optimize inference by reducing memory usage.
