...
* Many different [schedulers](fort-obsidian/diffusers/docs/source/en/api/schedulers/overview.md) - algorithms that control how noise is added for training, and how to generate denoised images during inference.
...
The [`DiffusionPipeline`] is the easiest way to use a pretrained diffusion system for inference. It is an end-to-end system containing the model and the scheduler. You can use the [`DiffusionPipeline`] out-of-the-box for many tasks. Take a look at the table below for some supported tasks, and for a complete list of supported tasks, check out the [🧨 Diffusers Summary](fort-obsidian/diffusers/docs/source/en/api/pipelines/overview.md#diffusers-summary) table.

| **Task**                     | **Description**                                                                                              | **Pipeline**
|------------------------------|--------------------------------------------------------------------------------------------------------------|-----------------|
| Unconditional Image Generation          | generate an image from Gaussian noise | [unconditional_image_generation](fort-obsidian/diffusers/docs/source/en/using-diffusers/unconditional_image_generation.md) |
| Text-Guided Image Generation | generate an image given a text prompt | [conditional_image_generation](fort-obsidian/diffusers/docs/source/en/using-diffusers/conditional_image_generation.md) |
| Text-Guided Image-to-Image Translation     | adapt an image guided by a text prompt | [img2img](fort-obsidian/diffusers/docs/source/en/using-diffusers/img2img.md) |
| Text-Guided Image-Inpainting          | fill the masked part of an image given the image, the mask and a text prompt | [inpaint](fort-obsidian/diffusers/docs/source/en/using-diffusers/inpaint.md) |
| Text-Guided Depth-to-Image Translation | adapt parts of an image guided by a text prompt while preserving structure via depth estimation | [depth2img](fort-obsidian/diffusers/docs/source/en/using-diffusers/depth2img.md) |
...
* Train or finetune a model to generate your own images in the [training](fort-obsidian/diffusers/docs/source/en/tutorials/basic_training.md) tutorial.
* See example official and community [training or finetuning scripts](https://github.com/huggingface/diffusers/tree/main/examples#-diffusers-examples) for a variety of use cases.
* Learn more about loading, accessing, changing, and comparing schedulers in the [Using different Schedulers](fort-obsidian/diffusers/docs/source/en/using-diffusers/schedulers.md) guide.
* Explore prompt engineering, speed and memory optimizations, and tips and tricks for generating higher-quality images with the [Stable Diffusion](fort-obsidian/diffusers/docs/source/en/stable_diffusion.md) guide.
* Dive deeper into speeding up 🧨 Diffusers with guides on [optimized PyTorch on a GPU](fort-obsidian/diffusers/docs/source/en/optimization/fp16.md), and inference guides for running [Stable Diffusion on Apple Silicon (M1/M2)](fort-obsidian/diffusers/docs/source/en/optimization/mps.md) and [ONNX Runtime](fort-obsidian/diffusers/docs/source/en/optimization/onnx.md).
