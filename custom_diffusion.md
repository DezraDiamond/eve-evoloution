...
Many of the basic parameters are described in the [DreamBooth](fort-obsidian/diffusers/docs/source/en/training/dreambooth.md#script-parameters) training guide, so this guide focuses on the parameters unique to Custom Diffusion:
...
Many of the parameters for prior preservation loss are described in the [DreamBooth](fort-obsidian/diffusers/docs/source/en/training/dreambooth.md#prior-preservation-loss) training guide.
...
A lot of the code in the Custom Diffusion training script is similar to the [DreamBooth](fort-obsidian/diffusers/docs/source/en/training/dreambooth.md#training-script) script. This guide instead focuses on the code that is relevant to Custom Diffusion.
...
In this guide, you'll download and use these example [cat images](https://www.cs.cmu.edu/~custom-diffusion/assets/data.zip). You can also create and use your own dataset if you want (see the [Create a dataset for training](fort-obsidian/diffusers/docs/source/en/training/create_dataset.md) guide).
