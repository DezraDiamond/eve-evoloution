...
For this guide, you'll download some images of a [cat toy](https://huggingface.co/datasets/diffusers/cat_toy_example) and store them in a directory. But remember, you can create and use your own dataset if you want (see the [Create a dataset for training](fort-obsidian/diffusers/docs/source/en/training/create_dataset.md) guide).
...
- Learn how to [load Textual Inversion embeddings](loading_adapters.md) and also use them as negative embeddings.
- Learn how to use [Textual Inversion](fort-obsidian/diffusers/docs/source/ko/using-diffusers/textual_inversion_inference.md) for inference with Stable Diffusion 1/2 and Stable Diffusion XL.