...
> [!TIP]
> Read the [Model files and layouts](fort-obsidian/diffusers/docs/source/en/using-diffusers/other-formats.md) guide to learn more about the Diffusers-multifolder layout versus the single-file layout, and how to load models stored in these different layouts.
