...
Many of the basic and important parameters are described in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#script-parameters) training guide, so this guide just focuses on the LoRA relevant parameters:
...
As with the script parameters, a walkthrough of the training script is provided in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#training-script) training guide. Instead, this guide takes a look at the LoRA relevant parts of the script.
...
- Learn how to [load different LoRA formats](loading_adapters.md#LoRA) trained using community trainers like Kohya and TheLastBen.
- Learn how to use and [combine multiple LoRA's](using_peft_for_inference.md) with PEFT for inference.
