...
|------------------------------|--------------------------------------------------------------------------------------------------------------|-----------------|
| Unconditional Image Generation          | generate an image from Gaussian noise | [unconditional_image_generation](fort-obsidian/diffusers/docs/source/ko/using-diffusers/unconditional_image_generation.md) |
| Text-Guided Image Generation | generate an image given a text prompt | [conditional_image_generation](fort-obsidian/diffusers/docs/source/ko/using-diffusers/conditional_image_generation.md) |
| Text-Guided Image-to-Image Translation     | adapt an image guided by a text prompt | [img2img](fort-obsidian/diffusers/docs/source/ko/using-diffusers/img2img.md) |
| Text-Guided Image-Inpainting          | fill the masked part of an image given the image, the mask and a text prompt | [inpaint](fort-obsidian/diffusers/docs/source/ko/using-diffusers/inpaint.md) |
| Text-Guided Depth-to-Image Translation | adapt parts of an image guided by a text prompt while preserving structure via depth estimation | [depth2img](fort-obsidian/diffusers/docs/source/ko/using-diffusers/depth2img.md) |
...
* [training](fort-obsidian/diffusers/docs/source/ko/tutorials/basic_training.md) 튜토리얼에서 모델을 학습하거나 파인튜닝하여 나만의 이미지를 생성할 수 있습니다.
...
* 스케줄러 로드, 액세스, 변경 및 비교에 대한 자세한 내용은 [다른 스케줄러 사용](fort-obsidian/diffusers/docs/source/ko/using-diffusers/schedulers.md) 가이드에서 확인하세요.
* [Stable Diffusion](fort-obsidian/diffusers/docs/source/ko/stable_diffusion.md) 가이드에서 프롬프트 엔지니어링, 속도 및 메모리 최적화, 고품질 이미지 생성을 위한 팁과 요령을 살펴보세요.
* [GPU에서 파이토치 최적화](fort-obsidian/diffusers/docs/source/ko/optimization/fp16.md) 가이드와 [애플 실리콘(M1/M2)에서의 Stable Diffusion](fort-obsidian/diffusers/docs/source/ko/optimization/mps.md) 및 [ONNX 런타임](fort-obsidian/diffusers/docs/source/ko/optimization/onnx.md) 실행에 대한 추론 가이드를 통해 🧨 Diffuser 속도를 높이는 방법을 더 자세히 알아보세요.