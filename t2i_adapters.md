...
Many of the basic and important parameters are described in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#script-parameters) training guide, so this guide just focuses on the relevant T2I-Adapter parameters:
...
As with the script parameters, a walkthrough of the training script is provided in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#training-script) training guide. Instead, this guide takes a look at the T2I-Adapter relevant parts of the script.
