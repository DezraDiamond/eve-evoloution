...
일반적으로, memory-efficient attention을 위해 [xFormers](https://github.com/facebookresearch/xformers) 사용을 추천하기 때문에, 추천하는 [설치 방법](fort-obsidian/diffusers/docs/source/ko/optimization/xformers.md)을 보고 설치해 보세요.
...
이를 활용하려면 다음을 만족해야 합니다:
 - PyTorch > 1.12
 - Cuda 사용 가능
 - [xformers 라이브러리를 설치함](fort-obsidian/diffusers/docs/source/ko/optimization/xformers.md)
```python
from diffusers import StableDiffusionPipeline
import torch
