...
In many cases, optimizing for memory or speed leads to improved performance in the other, so you should try to optimize for both whenever you can. This guide focuses on minimizing memory usage, but you can also learn more about how to [Speed up inference](fort-obsidian/diffusers/docs/source/en/optimization/fp16.md).
...
- PyTorch > 1.12
- CUDA available
- [xFormers](fort-obsidian/diffusers/docs/source/en/optimization/xformers.md)
...
The iteration speed when using `xformers` should match the iteration speed of PyTorch 2.0 as described [here](fort-obsidian/diffusers/docs/source/en/optimization/torch2.0.md).
