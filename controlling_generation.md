...
[DreamBooth](fort-obsidian/diffusers/docs/source/ko/training/dreambooth.md)는 모델을 파인튜닝하여 새로운 주제에 대해 가르칩니다. 즉, 한 사람의 사진 몇 장을 사용하여 다양한 스타일로 그 사람의 이미지를 생성할 수 있습니다.

사용 방법에 대한 자세한 내용은 [여기](fort-obsidian/diffusers/docs/source/ko/training/dreambooth.md)를 참조하세요.

## Textual Inversion

[Textual Inversion](fort-obsidian/diffusers/docs/source/ko/training/text_inversion.md)은 모델을 파인튜닝하여 새로운 개념에 대해 학습시킵니다. 즉, 특정 스타일의 아트웍 사진 몇 장을 사용하여 해당 스타일의 이미지를 생성할 수 있습니다.

사용 방법에 대한 자세한 내용은 [여기](fort-obsidian/diffusers/docs/source/ko/training/text_inversion.md)를 참조하세요.
...
자세한 설명과 예시는 [여기](fort-obsidian/diffusers/docs/source/ko/using-diffusers/weighted_prompts.md)를 참조하세요.

## Custom Diffusion

[Custom Diffusion](fort-obsidian/diffusers/docs/source/ko/training/custom_diffusion.md)은 사전 학습된 text-to-image 간 확산 모델의 교차 관심도 맵만 미세 조정합니다.
...
자세한 설명은 [공식 문서](fort-obsidian/diffusers/docs/source/ko/training/custom_diffusion.md)를 참조하세요.
...
[공식 문서](adapter.md)에서 사용 방법에 대한 정보를 참조하세요.