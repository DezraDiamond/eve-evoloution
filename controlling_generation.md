...
[InstructPix2Pix](pix2pix.md) is fine-tuned from Stable Diffusion to support editing input images. It takes as inputs an image and a prompt describing an edit, and it outputs the edited image.
...
pipeline might require more memory than a standard [StableDiffusionPipeline](text2img.md).
...
[Attend and Excite](attend_and_excite.md) allows subjects in the prompt to be faithfully represented in the final image.
...
Like Pix2Pix Zero, Attend and Excite also involves a mini optimization loop (leaving the pre-trained weights untouched) in its pipeline and can require more memory than the usual [StableDiffusionPipeline](text2img.md).

## Semantic Guidance (SEGA)

[Paper](https://arxiv.org/abs/2301.12247)

[SEGA](semantic_stable_diffusion.md) allows applying or removing one or more concepts from an image. The strength of the concept can also be controlled. I.e. the smile concept can be used to incrementally increase or decrease the smile of a portrait.
...
[Self-attention Guidance](self_attention_guidance.md) improves the general quality of images.
...
[Depth2Image](fort-obsidian/diffusers/docs/source/en/api/pipelines/stable_diffusion/depth2img.md) is fine-tuned from Stable Diffusion to better preserve semantics for text guided image variation.
...
[DreamBooth](fort-obsidian/diffusers/docs/source/en/training/dreambooth.md) fine-tunes a model to teach it about a new subject. I.e. a few pictures of a person can be used to generate images of that person in different styles.

## Textual Inversion

[Paper](https://arxiv.org/abs/2208.01618)

[Textual Inversion](fort-obsidian/diffusers/docs/source/en/training/text_inversion.md) fine-tunes a model to teach it about a new concept. I.e. a few pictures of a style of artwork can be used to generate images in that style.

## ControlNet

[Paper](https://arxiv.org/abs/2302.05543)

[ControlNet](fort-obsidian/diffusers/docs/source/en/api/pipelines/controlnet.md) is an auxiliary network which adds an extra condition.
There are 8 canonical pre-trained ControlNets trained on different conditionings such as edge detection, scribbles,
depth maps, and semantic segmentations.

## Prompt Weighting

[Prompt weighting](fort-obsidian/diffusers/docs/source/en/using-diffusers/weighted_prompts.md) is a simple technique that puts more attention weight on certain parts of the text
input.
...
[Custom Diffusion](fort-obsidian/diffusers/docs/source/en/training/custom_diffusion.md) only fine-tunes the cross-attention maps of a pre-trained
...
[DiffEdit](fort-obsidian/diffusers/docs/source/en/api/pipelines/diffedit.md) allows for semantic editing of input images along with
...
[T2I-Adapter](adapter.md) is an auxiliary network which adds an extra condition.
