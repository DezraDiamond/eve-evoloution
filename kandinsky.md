...
Most of the parameters are identical to the parameters in the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#script-parameters) training guide, so let's get straight to a walkthrough of the Kandinsky training scripts!
...
The training script is also similar to the [Text-to-image](fort-obsidian/diffusers/docs/source/en/training/text2image.md#training-script) training guide, but it's been modified to support training the prior and decoder models. This guide focuses on the code that is unique to the Kandinsky 2.2 training scripts.
...
- Read the [Kandinsky](fort-obsidian/diffusers/docs/source/en/using-diffusers/kandinsky.md) guide to learn how to use it for a variety of different tasks (text-to-image, image-to-image, inpainting, interpolation), and how it can be combined with a ControlNet.
- Check out the [DreamBooth](fort-obsidian/diffusers/docs/source/en/training/dreambooth.md) and [LoRA](fort-obsidian/diffusers/docs/source/en/training/lora.md) training guides to learn how to train a personalized Kandinsky model with just a few example images. These two training techniques can even be combined!
