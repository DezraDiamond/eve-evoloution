...
For models, you can also specify the [*variant*](fort-obsidian/diffusers/docs/source/en/using-diffusers/loading.md#checkpoint-variants) of the weights to push to the Hub. For example, to push `fp16` weights:
