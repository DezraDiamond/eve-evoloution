...
* It can generate videos of quality that is often on par with [Stable Video Diffusion](fort-obsidian/diffusers/docs/source/en/using-diffusers/svd.md) (SVD).
