...
To generate a 3D object from another image, use the [`ShapEImg2ImgPipeline`]. You can use an existing image or generate an entirely new one. Let's use the [Kandinsky 2.1](fort-obsidian/diffusers/docs/source/en/api/pipelines/kandinsky.md) model to generate a new image.
