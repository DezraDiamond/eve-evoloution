...
🤗 Diffusers is the go-to library for state-of-the-art pretrained diffusion models for generating images, audio, and even 3D structures of molecules. Whether you're looking for a simple inference solution or want to train your own diffusion model, 🤗 Diffusers is a modular toolbox that supports both. Our library is designed with a focus on [usability over performance](fort-obsidian/diffusers/docs/source/en/conceptual/philosophy.md#usability-over-performance), [simple over easy](fort-obsidian/diffusers/docs/source/en/conceptual/philosophy.md#simple-over-easy), and [customizability over abstractions](fort-obsidian/diffusers/docs/source/en/conceptual/philosophy.md#tweakable-contributorfriendly-over-abstraction).

The library has three main components:

- State-of-the-art diffusion pipelines for inference with just a few lines of code. There are many pipelines in 🤗 Diffusers, check out the table in the pipeline [overview](fort-obsidian/diffusers/docs/source/en/api/pipelines/overview.md) for a complete list of available pipelines and the task they solve.
- Interchangeable [noise schedulers](fort-obsidian/diffusers/docs/source/en/api/schedulers/overview.md) for balancing trade-offs between generation speed and quality.
