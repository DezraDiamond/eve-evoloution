...
> [!TIP]
> Refer to the scheduler API [overview](fort-obsidian/diffusers/docs/source/en/api/schedulers/overview.md) for a list of schedulers that support Karras sigmas.
>
